...
export default class News extends Component {    
    ...
    constructor() {
        ...
        document.title='NewsFreaks - General'
    }

    async componentDidMount() {
        this.setProgress(0)
        let url = "https://newsapi.org/v2/top-headlines?country=in&category=politics&apiKey=617fc18b4285418f982cfbca41cd1bc4&page=1"
            ...
            <>            
                ...
                <nav className="navbar navbar-expand-lg fixed-top">
                    <div className="container-fluid">
                        <Link to='/' className="navbar-brand" style={{ color: 'white',fontWeight:'bold'  }}>NewsFreaks</Link>
                ...
                <h1 style={{ textAlign: 'center', marginTop: '13%', fontSize: '50px',fontWeight:'bold' }}>General - Top Headlines</h1>
                <div className="page1">
