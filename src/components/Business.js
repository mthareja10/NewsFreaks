...
export default class News extends Component {
    ...
    constructor() {
        ...
        document.title='NewsFreaks - Business'
    }

    async componentDidMount() {
        this.setProgress(0)
        let url = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=617fc18b4285418f982cfbca41cd1bc4&page=1"
    ...
    render() {
        ...
        return (
            <>
                ...
                <h1 style={{ textAlign: 'center', marginTop: '3%', fontSize: '50px',fontWeight:'bold'  }}>Business - Top Headlines</h1>
                <div className="page1">
