...
export default class News extends Component {
    ...
    constructor() {
        ...
        document.title='NewsFreaks - Music'
    }

    async componentDidMount() {
        this.setProgress(0)
        let url = "https://newsapi.org/v2/top-headlines?country=in&category=music&apiKey=617fc18b4285418f982cfbca41cd1bc4&page=1"
        ...
        return (
            <>
             <LoadingBar
                ...
                <h1 style={{textAlign:'center',marginTop:'3%',fontSize:'50px',fontWeight:'bold' }}>Music - Top Headlines</h1>
                <div className="page1">
